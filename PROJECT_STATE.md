...
| Owner editor (QX-03 / QX-03R / QX-03R2) | persistent AI; photo overlay workspace; wall registration separate from A–B scale; atomic APPLY; fail-closed placement; locked delete; 3D canvas drag |
