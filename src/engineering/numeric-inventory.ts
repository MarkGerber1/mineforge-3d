...
export const SAFETY_NUMERIC_INVENTORY: NumericInventoryEntry[] = [
  ...
  { path: "fleet.imported.frequencyMinHz", class: "SAFETY_DRIVING", rule: "if present: finite > 0; pair with frequencyMaxHz; ≤ max", invalid: 0 },
  { path: "fleet.imported.frequencyMaxHz", class: "SAFETY_DRIVING", rule: "if present: finite > 0; pair with frequencyMinHz; ≥ min", invalid: -1 },
  { path: "fleet.imported.inputPhases", class: "SAFETY_DRIVING", rule: "if present: 1 | 3", invalid: 2 },
